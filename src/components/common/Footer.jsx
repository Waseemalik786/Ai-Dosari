...
const Footer = () => {
  ...
  return (
    <footer className="bg-black/90 text-white overflow-hidden">
      {/* Decorative elements */}
      ...
      {/* Main Footer Content */}
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 pt-17 relative">
            ...
            <div className="flex space-x-4">
              {[ 
                ...
                <a 
                  key={index}
                  href="#" 
                  className="bg-green-600 p-3 rounded-full transition-all duration-300 text-white transform hover:-translate-y-1 shadow-md hover:shadow-lg flex items-center justify-center group overflow-hidden relative"
                  data-aos="zoom-in" 
      ...
      {/* Bottom Bar */}
      <div className="border-t border-yellow-400 py-3 relative">
